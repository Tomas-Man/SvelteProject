<!-- Con este script se crea el carrusel -->
<script>
    import Siema from 'siema';
    import { onMount, createEventDispatcher } from 'svelte';

    //esto son distintos parámetros que nos permiten cambiar el funcionamiento del carrusel
    ...
    //a partir de aqui se crea el funcionamiento del carrusel
